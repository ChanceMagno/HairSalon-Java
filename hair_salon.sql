...
COPY clients (id, first_name, last_name, phone_number, email, age, gender, stylist_id) FROM stdin;
\.
...
COPY stylists (id, first_name, last_name, phone_number, email, hire_date) FROM stdin;
\.
